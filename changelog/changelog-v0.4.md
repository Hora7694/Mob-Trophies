...
* **Localization**: [Added languages or text corrections].


## 👁️ Visual
* **Rendering**: [Visual improvements or graphical bug fixes].
* **Asset Optimization**: [Transition to native textures or mod size reduction].


## 🪲 Fixed bugs in Version [v0.4]
* **[Fix Name]**: [Brief description of what was fixed (e.g., server crash, config error)].
* **Hitbox Correction**: [Details on collision changes or interaction box adjustments].
* **Stability**: [Improvements related to performance or asset validation].
